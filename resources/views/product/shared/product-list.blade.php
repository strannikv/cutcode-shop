<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="{{ route('product', ['product'=>$item->slug]) }}"
       class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
        <img src="
        {{ $item->makeThumbnail('345x320') }}
        " class="object-cover w-full h-full" alt="SteelSeries Aerox 3 Snow">
    </a>
    <div class="grow flex flex-col py-8 px-6">
        ...
        <ul class="space-y-1 mt-4 text-xxs">
            ...
            <li class="flex justify-between text-body"><strong>Количество кнопок мыши:</strong> 3></li>
